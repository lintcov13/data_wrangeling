...
* `pups_born_alive >= 2`
* `pups_survive != 4`
* `!(pups_survive == 4)` #this will filter out all of the rows that num of pups does not equal 4 
* `!((pups_survive == 4) & (gd_of_birth ==20))` #can select multiple this way -> logical expressions 
...
This makes multiple datasets with different atributes from one dataset
```{r}
